...
function Pagination(props) {
    ...
    const goBookingList = (id) => {
        return navigate('/movie/pre-booking/hall/list/' + id, {
            state: {
                token: props.token,
                title: 'Pre Booking List',
                name: props.name,
                requestName: 'pending_movie_request'
            }
        })
    }
    ...
    const goConfirmBookingList = (id) => {
        return navigate('/movie/confirm-booking/hall/list/' + id, {
            state: {
                token: props.token,
                title: 'Confirm Booking List',
                name: props.name,
                requestName: 'approve_movie_request'
            }
        })
    }
            ...
            <div style={{position: 'relative', marginTop: '60px'}}>
                <Card style={{width: '600px', height: 'auto', backgroundColor: 'white', borderRadius: '8px'}}>
                    ...
                    <CardBody>
                        ...
                        <Button
                            style={{background: 'transparent', height: '40px', marginTop: '20px', marginLeft: '0px'}}
