      ...
      <Card style={{width: '500px', height: 'auto', backgroundColor: 'white', borderRadius: '8px'}}>
        ...
        <CardBody>
          ...
          <div style={{display: 'flex'}}>
            <div style={{flex: '1'}}>
              <img src={imageSrc} alt='Poster' style={{height: '200px', width: '200px'}}/>
            </div>
            <div style={{flex: 1}}>
        ...
        {/*<div>{genreString}</div>*/}
        <div style={{border: '3px solid black', fontStyle: 'italic', fontWeight: 'bolder', color: 'rebeccapurple'}}>{props.description}</div>
          ...
          <div>
            ...
            <div style={{display: 'flex'}}>
              ...
              <div style={{marginRight: '250px', marginTop: '10px', fontSize: '18', fontWeight: 'bold', color: 'darkred'}}>
                Superhit
              </div>
