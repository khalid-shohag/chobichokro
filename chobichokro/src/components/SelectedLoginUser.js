...
import {useNavigate} from 'react-router-dom'; // Import the new hooks
...
const DropdownMenu = () => {
    ...
    const menuItems = ['Admin', 'Distributor', 'Theatre', 'Audience', 'Get License', 'License Status check', 'About'];
