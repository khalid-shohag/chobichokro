...
import {FaEnvelope, FaFilm, FaHeart, FaPen, FaPhone, FaStar} from "react-icons/fa";
            ...
            <div className="container-das scrollable-page-das">
                ...
                <div className="column-das start-content-das" style={{flexDirection: 'column'}}>
                    <div style={{display: 'flex', justifyContent: 'space-between'}}>
                        <Button className="btn-das" style={{
                        ...
                        <Button className="btn-das"
                                style={{backgroundColor: 'black', color: 'white', fontSize: '20px', fontWeight: 'bold'}}
                        ...
                        <Button className="btn-das"
                                style={{backgroundColor: 'aqua', color: 'white', fontSize: '20px', fontWeight: 'bold'}}>
                            <Card>
