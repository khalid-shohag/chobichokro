...
const MyDocument = (props) => (
    ...
    <Document>
        ...
        <Page size="A2" style={styles.page}>
            ...
            <View>
                <Text style={{fontSize: 18, fontWeight: 'bold', marginBottom: 10, marginLeft: '500px'}}>Reel Booking
                    info.</Text>
...
//   const amount = props.seats.length * 130
    return (
        <PDFViewer PDFViewer style={{width: '100%', height: '1000px'}}>
            ...
            <MyDocument distributor={"ABC Films"} address={"Bannani, Dhaka"} theatre={"Star cineplex"}
                        transaction={"5655688"} amount={'50000'} post={"Rajshahi"}/>
        </PDFViewer>
