    ...
    return(
        <div>
            ...
            <div style={{marginTop: '80px'}}>
                ...
                {theatreList.map((rv) => {
                    return(
                        <Card key={rv.id} style={{ marginLeft: '35%', padding: '10px', fontStyle: 'italic', fontSize: '18px', marginBottom: '30px', borderRadius: '5px', height: 'auto', width: '35%', backgroundColor: 'lavender'}}>
