            ...
            close => (
                <div >
                    ...
                    <textarea id="textAreaExample"
                        style={{ width: '400px', height: "12rem", backgroundColor: 'white', borderRadius: '7px', boxShadow: '0 0 10px black' }}
                        
                        placeholder="Add description..."
                     />
                </div>
                <button style={{backgroundColor: 'green', borderRadius: '5%', marginTop: '10px', marginLeft: '40%', border: 'none' }} onClick=
                    {() => {
                        handlePost().then(() => { close() })
